...
def script_main_function(args): 
    ...
    rootservice = RootChainService() #Inicializamos el nodo (Deberemos tener el admin file path puesto)
    rootservice.launchme( args.main_node_host , args.main_node_port) #Lanzamos el servidor
    return
